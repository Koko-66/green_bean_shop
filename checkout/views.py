...
class SuccessView(TemplateView):
    ...
    #     """Overwrite the default get method to get order and
    #     information about saving info preferences"""

    #     save_info = request.session.get('save_info')
    #     order_number = self.kwargs.get('order_number')
    #     order = get_object_or_404(Order, order_number=order_number)
    #     messages.success(request, f"Thank you for your order. Your order \
    #         number is {order_number}. Confirmation e-mail will be sent to \
    #         {order.email}")
